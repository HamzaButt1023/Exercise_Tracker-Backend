...
// Route1: Get all the exercises using: GET "/api/exercise/fetchallexercises".Login required
...
// Route2: Add a new exercise using: POST "/api/exercise/addexercise".Login required
router.post(
    "/addexercise",
    fetchuser, [
...
// Route3: Update an exisitng exercise using: PUT "/api/exercise/updateexercise".Login required
router.put("/updateexercise/:id", fetchuser, async(req, res) => {
    ...
    try {
        ...
        // Find the exercise to be updated and update it.
        ...
        exercise = await Exercise.findByIdAndUpdate(
            req.params.id, { $set: newExercise }, { new: true }
        );
        res.json({
            success: true,
            exercise,
...
// Route4: Delete an exisitng exercise using: DELETE "/api/exercise/deleteexercise".Login required
